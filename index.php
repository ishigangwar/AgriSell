...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>TEAM_KIH_DBMS_PROJECT</title>
	...
	?>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">AgriSell &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agro Culture Fam<span>SRMIST</span></p>
			</div>
			<div>
		...
		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About AgriSell</b></span>
				AgriSell is an e-commerce trading platform for grains & grocerries...
			</p>
